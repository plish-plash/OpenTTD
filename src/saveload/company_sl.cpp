...
static const SaveLoad _company_desc[] = {
	...
	SLE_CONDARR(CompanyProperties, yearly_expenses,       SLE_INT64, 3 * 13,                  SLV_2, SLV_INFRASTRUCTURE_SHARING),
	SLE_CONDARR(CompanyProperties, yearly_expenses,       SLE_INT64, 3 * EXPENSES_END,        SLV_INFRASTRUCTURE_SHARING, SL_MAX_VERSION),
